...
for (const project of config.projects) {
  ...
  const after = status(project.root_path); if (after !== before) throw new Error(`PROJECT_WORKTREE_CHANGED_DURING_OWNER_BOUNDARY: ${project.project_id}`);
}
