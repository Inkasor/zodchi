...
const required = [
  ...
  "tools/browser-proof.mjs",
  "tools/browser-sentinel.mjs",
  "tools/claude-skill-boundary-smoke.mjs",
  "tools/codex-browser-smoke.mjs",
  "tools/codex-readonly-smoke.mjs",
  "tools/kimi-write-boundary-smoke.mjs",
  "tools/local-endpoint-boundary-smoke.mjs",
  "tools/mcp-browser-smoke.mjs",
  "tools/profile-policy-audit.mjs",
  "tools/profile-policy-prune.mjs",
