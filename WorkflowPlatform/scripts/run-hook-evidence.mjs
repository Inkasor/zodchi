...
function hookInput(scenario, cwd) { return scenario.client === "claude-code" ? { session_id: "hook-evidence-session", prompt_id: scenario.event, transcript_path: "", hook_event_name: "UserPromptSubmit", cwd, prompt: scenario.message } : { event_id: scenario.event, prompt: scenario.message, cwd }; }
