...
function hookInput(scenario, cwd) { return scenario.client === "claude-code" ? { session_id: "hook-evidence-session", prompt_id: scenario.event, hook_event_name: "UserPromptSubmit", cwd, user_input: scenario.message, user_input_raw: scenario.message } : { event_id: scenario.event, prompt: scenario.message, cwd }; }
