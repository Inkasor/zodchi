...
export function classifierPrompt({ message, catalog, projectSnapshot, acceptedDecisions = [], currentState = null, responseLanguage = "en" }) {
  ...
  const invariant = [
    "WORKFLOW CLASSIFICATION CONTRACT v6",
