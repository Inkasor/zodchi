...
function companyWebPackages() {
  ...
  return [
    companyWebPackage({ key: "zodchi.product-development", version: "2.2.0", purpose: "Zodchi product development workflow with separate source, installed release and local data boundaries.", checks: zodchiChecks, codeChecks: ["zodchi_tests"], dataChecks: ["zodchi_tests"], releaseChecks: ["zodchi_tests", "zodchi_release_build"], documents: [
