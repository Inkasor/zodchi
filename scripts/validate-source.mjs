...
for (const relative of ["ONBOARDING_PROMPT.md", "QUICKSTART.md", "UPDATE.md", "configs/WorkflowPlatformArchitecture.template.md", "docs/ARCHITECTURE.md", "WorkflowPlatform/docs/WorkflowPlatform.md"]) {
...
process.stdout.write(`${JSON.stringify({ status: "passed", product: product.name, version: product.version, semantic_documents: 6 })}\n`);
