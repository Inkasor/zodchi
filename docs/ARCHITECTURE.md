<document id="zodchi_architecture" status="accepted" authority="zodchi" version="0.6.12" language="en">
  ...
  <contracts status="accepted">
    ...
    <rule id="executor_capability_routing">Portable role contracts declare executor capabilities, while AgentGateway derives provider-specific technical, declarative, unavailable, and unknown guarantees from local profiles. Readiness and execution fail closed unless required capabilities are technically available and forbidden capabilities are technically absent.</rule>
